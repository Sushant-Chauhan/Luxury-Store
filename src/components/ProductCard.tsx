  ...
  return (
    <>
      <motion.div
        ...
        className="group relative overflow-hidden rounded-lg hover-lift glass-card cursor-pointer"
      ...
      <ProductDialog
        product={{ name, price, image, brand, description, rating, returnPolicy, replacementDays, stockStatus, features, ...rest }}
        open={dialogOpen}
